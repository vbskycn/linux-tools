...
show_toolbox_info() {
    ...
    echo -e "\033[1;33mLinux-Tools 脚本工具箱 v1.30.21 让你更简单的用上Linux！\033[0m"
...
if [ "$0" != "/usr/local/bin/linux-tools" ]; then
    curl -sS -O https://github.zhoujie218.top/https://raw.githubusercontent.com/vbskycn/linux-tools/main/linux-tools.sh
...
show_main_menu() {
    ...
    case $main_choice in
        ...
        00) curl -sS -O https://github.zhoujie218.top/https://raw.githubusercontent.com/vbskycn/linux-tools/main/linux-tools.sh && \
            chmod +x linux-tools.sh && \
...
show_script_menu() {
    ...
    case $choice in
        1|script1) 
            echo "安装 kejilion 脚本..."
            curl -sS -O https://github.zhoujie218.top/https://raw.githubusercontent.com/kejilion/sh/main/kejilion.sh && chmod +x kejilion.sh && ./kejilion.sh
            echo -e "\033[1;32m按任意键返回...\033[0m"
            read -n 1
            show_script_menu 
            ;;
        2|script2) 
            echo "安装 勇哥的SB 脚本..."
            bash <(curl -Ls https://github.zhoujie218.top/https://raw.githubusercontent.com/yonggekkk/sing-box-yg/main/sb.sh)
            echo -e "\033[1;32m按任意键返回...\033[0m"
            read -n 1
            show_script_menu 
            ;;
